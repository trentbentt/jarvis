...
| C2 | LiteLLM logging path decision | ⏳ Pending | Read v11 rationale + `grep database ~/litellm/config.yaml` | 30 min. Whether `quota.py` queries Postgres `spend_logs` directly or tails JSON file logs. |
